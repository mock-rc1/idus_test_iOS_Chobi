//
//  ClassOnlineBannerTableViewCell.swift
//  IdusCloneApp
//
...
class ClassOnlineBannerTableViewCell: UITableViewCell , UICollectionViewDelegateFlowLayout{
    ...
    func setNib()  {
        ...
        let cellNib = UINib(nibName: "ClassOnlineBannerCollectionViewCell", bundle: nil)
                self.collectionView.register(cellNib, forCellWithReuseIdentifier: "ClassOnlineBannerCollectionViewCell")
    }
    // 2초마다 실행되는 타이머
        func bannerTimer() {
...
extension ClassOnlineBannerTableViewCell : UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ClassOnlineBannerCollectionViewCell", for: indexPath) as? ClassOnlineBannerCollectionViewCell {
